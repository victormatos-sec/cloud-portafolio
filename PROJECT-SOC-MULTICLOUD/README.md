...
![Sentinel Configuration](https://github.com/victormatos-sec/cloud-portafolio/blob/main/PROJECT-SOC-MULTICLOUD/Screenshots-SOC/Step1.png)
...
![Defender Foundational Plan](https://github.com/victormatos-sec/cloud-portafolio/blob/main/PROJECT-SOC-MULTICLOUD/Screenshots-SOC/Step2.1.png)
...
![Add AWS Account](https://github.com/victormatos-sec/cloud-portafolio/blob/main/PROJECT-SOC-MULTICLOUD/Screenshots-SOC/Step2.1.1.png)
![AWS Plans in MDC](https://github.com/victormatos-sec/cloud-portafolio/blob/main/PROJECT-SOC-MULTICLOUD/Screenshots-SOC/2.1.2.png)
...
![AWS CloudFormation Template](https://github.com/victormatos-sec/cloud-portafolio/blob/main/PROJECT-SOC-MULTICLOUD/Screenshots-SOC/step2.2.png)

* Executed and confirmed the successful stack creation in the AWS CloudFormation console (`CREATE_COMPLETE`).

![CloudFormation Events](https://github.com/victormatos-sec/cloud-portafolio/blob/main/PROJECT-SOC-MULTICLOUD/Screenshots-SOC/step2.2.1.png)

* Completed the connector creation, successfully linking the connected AWS account alongside the Azure subscription.

![AWS Connector Created](https://github.com/victormatos-sec/cloud-portafolio/blob/main/PROJECT-SOC-MULTICLOUD/Screenshots-SOC/step2.2.2.png)
![Connected Clouds Summary - AWS](https://github.com/victormatos-sec/cloud-portafolio/blob/main/PROJECT-SOC-MULTICLOUD/Screenshots-SOC/step2.2.3.png)
...
![AWS S3 Bucket](https://github.com/victormatos-sec/cloud-portafolio/blob/main/PROJECT-SOC-MULTICLOUD/Screenshots-SOC/Step2.3.png)
...
![Multi-region CloudTrail](https://github.com/victormatos-sec/cloud-portafolio/blob/main/PROJECT-SOC-MULTICLOUD/Screenshots-SOC/Step2.3.1.png)
...
![Add GCP Project](https://github.com/victormatos-sec/cloud-portafolio/blob/main/PROJECT-SOC-MULTICLOUD/Screenshots-SOC/Step3.1.png)
...
![GCP Cloud Shell Script](https://github.com/victormatos-sec/cloud-portafolio/blob/main/PROJECT-SOC-MULTICLOUD/Screenshots-SOC/Step3.1.1.png)

* Verified proper synchronization and establishment of the GCP connector in Azure.

![GCP Connector Successful](https://github.com/victormatos-sec/cloud-portafolio/blob/main/PROJECT-SOC-MULTICLOUD/Screenshots-SOC/Step3.1.2.png)
![Multicloud Summary with GCP](https://github.com/victormatos-sec/cloud-portafolio/blob/main/PROJECT-SOC-MULTICLOUD/Screenshots-SOC/Step3.1.3.png)
...
![GCP Pub/Sub and Sinks Setup](https://github.com/victormatos-sec/cloud-portafolio/blob/main/PROJECT-SOC-MULTICLOUD/Screenshots-SOC/Step3.2.png)
...
![Install AWS Solution in Sentinel](https://github.com/victormatos-sec/cloud-portafolio/blob/main/PROJECT-SOC-MULTICLOUD/Screenshots-SOC/Step4.1.png)
![AWS S3 Connector in Sentinel](https://github.com/victormatos-sec/cloud-portafolio/blob/main/PROJECT-SOC-MULTICLOUD/Screenshots-SOC/Step4.3.png)
...
![Install GCP Solution in Sentinel](https://github.com/victormatos-sec/cloud-portafolio/blob/main/PROJECT-SOC-MULTICLOUD/Screenshots-SOC/Step4.4.png)
![GCP Pub/Sub Connector Config](https://github.com/victormatos-sec/cloud-portafolio/blob/main/PROJECT-SOC-MULTICLOUD/Screenshots-SOC/Step4.6.png)
![](https://github.com/victormatos-sec/cloud-portafolio/blob/main/PROJECT-SOC-MULTICLOUD/Screenshots-SOC/Step4.7.png)
...
![KQL GCPAuditLogs Query](https://github.com/victormatos-sec/cloud-portafolio/blob/main/PROJECT-SOC-MULTICLOUD/Screenshots-SOC/Step4.8.png)
...
![Create Logic App Playbook](https://github.com/victormatos-sec/cloud-portafolio/blob/main/PROJECT-SOC-MULTICLOUD/Screenshots-SOC/Step5.1.png)
![Logic Apps Playbook Designer](https://github.com/victormatos-sec/cloud-portafolio/blob/main/PROJECT-SOC-MULTICLOUD/Screenshots-SOC/step5.1.1.png)
...
![Create Sentinel Analytics Rule](https://github.com/victormatos-sec/cloud-portafolio/blob/main/PROJECT-SOC-MULTICLOUD/Screenshots-SOC/Step5.2.png)
![GCP VM Rule Configuration](https://github.com/victormatos-sec/cloud-portafolio/blob/main/PROJECT-SOC-MULTICLOUD/Screenshots-SOC/Step5.2.1.png)
![Active Rules in Sentinel](https://github.com/victormatos-sec/cloud-portafolio/blob/main/PROJECT-SOC-MULTICLOUD/Screenshots-SOC/Step5.2.2.png)
...
![Rule KQL Query](https://github.com/victormatos-sec/cloud-portafolio/blob/main/PROJECT-SOC-MULTICLOUD/Screenshots-SOC/Step5.2.3.png)
...
![GCP VM Creation and Deletion](https://github.com/victormatos-sec/cloud-portafolio/blob/main/PROJECT-SOC-MULTICLOUD/Screenshots-SOC/step6.1.png)
...
![Sentinel Incident Generated](https://github.com/victormatos-sec/cloud-portafolio/blob/main/PROJECT-SOC-MULTICLOUD/Screenshots-SOC/step6.2.png)
...
![Received Email Notification](https://github.com/victormatos-sec/cloud-portafolio/blob/main/PROJECT-SOC-MULTICLOUD/Screenshots-SOC/step6.3.png)
